...
void sort_rec(Iterator a, ptrdiff_t left, ptrdiff_t right, bool leftmost, Comp comp) {
  ...
  if (comp(a[e3], a[e2])) { T t = std::move(a[e3]); a[e3] = std::move(a[e2]); a[e2] = t;
    if (comp(t, a[e1])) { a[e2] = std::move(a[e1]); a[e1] = std::move(t); }
  }
  if (comp(a[e4], a[e3])) { T t = std::move(a[e4]); a[e4] = std::move(a[e3]); a[e3] = t;
    if (comp(t, a[e2])) { a[e3] = std::move(a[e2]); a[e2] = t;
      if (comp(t, a[e1])) { a[e2] = std::move(a[e1]); a[e1] = std::move(t); }
    }
  }
  if (comp(a[e5], a[e4])) { T t = std::move(a[e5]); a[e5] = std::move(a[e4]); a[e4] = t;
    if (comp(t, a[e3])) { a[e4] = std::move(a[e3]); a[e3] = t;
      if (comp(t, a[e2])) { a[e3] = std::move(a[e2]); a[e2] = t;
        if (comp(t, a[e1])) { a[e2] = std::move(a[e1]); a[e1] = std::move(t); }
      }
    }
